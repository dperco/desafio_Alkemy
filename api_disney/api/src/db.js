...
const {Character , Gener , Movies } = sequelize.models;

// Aca vendrian las relaciones
// Product.hasMany(Reviews);
Character.belongsToMany(Movies,{through:"character_movie"});
Movies.belongsToMany(Character,{through:"character_movie"});
